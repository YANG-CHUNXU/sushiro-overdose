    ...
    <div class="grid">
      ...
      <aside class="side">
        ...
        <div class="card">
          <h2>新手路径</h2>
          <div class="track">
            <div class="step" id="step-capture"><div class="mark">1</div><div><b>获取认证</b><span>重启 PC 微信后打开寿司郎小程序完成。</span></div></div>
...
function uD(){
  ...
  if(es.status==='capturing'){
    badge.textContent='正在获取认证';title.textContent='重启 PC 微信';copy.textContent='完全退出并重新打开 PC 微信，再在寿司郎小程序中进行一次排队或预约操作。';
    ...
    badge.textContent='首次设置';title.textContent='先获取认证参数';copy.textContent='点击开始后按页面状态重启 PC 微信，并完成一次寿司郎小程序操作。';
