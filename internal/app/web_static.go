...
async function saveQueueAlerts(){try{await fetch('/api/queue/alerts',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({rules:qtAlerts})});renderQueueAlerts()}catch(e){toast('保存提醒失败')}}
